...
class MultiLabelProcessor(DataProcessor): 
    ...
    def get_dev_examples(self, data_dir):
        ...
        #filename = 'dev.csv'
        #data_df = pd.read_csv(os.path.join(data_dir, filename))
        data_df = pd.read_csv(os.path.join(data_dir, 'dev.csv'))
...
def file_based_input_fn_builder(input_file, seq_length, is_training,
    ...
    name_to_features = {
        ...
        "label_ids": tf.FixedLenFeature([3], tf.int64), #HERE
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        ############ HERE
        # last layer. Can be changed to fit your data
        # Here is an example using sigmoid function
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(per_example_loss, label_ids, probabilities, is_real_example):
                ...
                for j, logits in enumerate(logits_split):
                    ...
                    auc = tf.metrics.auc(label_id_, logits)

                    eval_dict['auc: '+str(j)] = auc
